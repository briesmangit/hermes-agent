...
export const en: Translations = {
  ...
  sidebar: {
    ...
    showSunset: 'Show Sunset sessions',
    completedTtlLabel: 'Completed TTL',
    completedTtl5m: '5 min',
    completedTtl15m: '15 min',
    completedTtl30m: '30 min',
    completedTtl1h: '1 hour',
    completedTtlSticky: 'Sticky',
    priority: 'Priority',
    markPriority: 'Mark as Priority',
    clearPriority: 'Clear Priority',
    prioritySection: 'Priority',
    kanban: 'Kanban',
    markKanban: 'Mark as Kanban',
    clearKanban: 'Clear Kanban',
    kanbanSection: 'Kanban',
    sortCreated: 'Created',
    sortOpened: 'Opened',
    sortByCreated: 'Sort Recents by creation time',
    sortByOpened: 'Sort Recents by last opened (reopen floats to top)',
    cronJobs: 'Cron jobs',
